...
public class ai_inClass_10252022 {
    public static void main(String[] args) throws InterruptedException {
        ...
        // add the options for maximizing and incognito for Chrome
        ...
        destination.add("Wisconsin");
        destination.add("Wyoming");
...
//           Thread.sleep(2000);
            ...
            try {
                if (i == 0) {
                    //click on 5th hotel package
                    driver.findElements(By.xpath("//*[contains@class='uitk-image-link']")).get(4).click();
                } else if (i == 1) {
                    //click on 5th hotel package
                    driver.findElements(By.xpath("//*[contains@class='uitk-image-link']")).get(4).click();
                } else if (i == 2) {
                    //click on 4th hotel package
                    driver.findElements(By.xpath("//*[contains@class='uitk-image-link']")).get(5).click();
                }
            } catch (Exception e){
