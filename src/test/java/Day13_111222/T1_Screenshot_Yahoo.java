...
public class T1_Screenshot_Yahoo extends Reusable_Annotations {
    ...
    public void tc001_verifySignedInOptionIsChecked() throws InterruptedException {
        ...
        //this will fail because the xpath is incorrect (screenshot should be attached to the HTML report)
        ReusableActions_Loggers.clickAction(driver,"//*[@class = '_yb_1933yyyy']",logger,"Sign In");
